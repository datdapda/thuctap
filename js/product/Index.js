...
function renderHeaderFooter() {
    header.innerHTML = `
  <section class="backgroundQC" id="background">
            <div class="slideQC-background col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                <div class="alert fade in background">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">[&times;]</button>
                    <img src="/img/backgroundQC.png" class=" col-lg-6 col-md-8 col-sm-7 col-xs-8">
                </div>
            </div>
        </section>
            ...
            <div class="container Header">
                <div class="SignUp col-lg-7 " id="login">
                    <ul>
                        ...
                        <li class="mobi" data-toggle="modal"
                        data-target="#exampleModal"
                        data-whatever="@mdo"><a href="#"><i class="fa fa-hand-o-right"></i> Theo dõi đơn hàng</a></li>
                        <li class="mobi"><a href="/404.html">Tra cứu bảo hành</a></li>
                    </ul>
                </div>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (name === "admin" && pass === "admin") {
        ...
        background.classList.add("Logined");
        document.querySelector("#linkLogin").addEventListener("click", e => {
            e.preventDefault();

            background.classList.remove("Logined");
...
const productsE4 = document.querySelector(".products4");
const productsE5 = document.querySelector(".products5");
const productsE6 = document.querySelector(".products6");
...
function renderProdcuts() {
    ...
    products.forEach((product) => {
      ...
      `;
        } else if (product.id >= 6 && product.id < 12) {
        ...
        `;
        } else if (product.id >= 24 && product.id < 30) {
...
function addToCart3(id) {
    ...
    if (cart.some((item) => item.id === id)) {
        ...
        const item = products3.find((products3) => products3.id === id);
...
function addToCart4(id) {
    ...
    if (cart.some((item) => item.id === id)) {
        ...
        const item = products4.find((products4) => products4.id === id);
...
function addToCart5(id) {
    // check if prodcut already exist in cart
    if (cart.some((item) => item.id === id)) {
        changeNumberOfUnits("plus", id);
    } else {
        const item = products5.find((products5) => products5.id === id);
...
function addToCart6(id) {
    // check if prodcut already exist in cart
    if (cart.some((item) => item.id === id)) {
        changeNumberOfUnits("plus", id);
    } else {
        const item = products6.find((products6) => products6.id === id);
...
const chosed1 = document.querySelector(".chosed1")
const chosed2 = document.querySelector(".chosed2")
const chosed3 = document.querySelector(".chosed3")
const chosed4 = document.querySelector(".chosed4")
...
chosed1.addEventListener("click", e => {
    localStorage.setItem("Search", 2);
    localStorage.setItem("inputbox", "Máy ảnh")
    location.href = "/Group.html"
})
chosed2.addEventListener("click", e => {
    localStorage.setItem("Search", 2);
    localStorage.setItem("inputbox", "Âm thanh")
    location.href = "/Group.html"
})
chosed3.addEventListener("click", e => {
    localStorage.setItem("Search", 2);
    localStorage.setItem("inputbox", "Ống kính")
    location.href = "/Group.html"
})
chosed4.addEventListener("click", e => {
    localStorage.setItem("Search", 2);
    localStorage.setItem("inputbox", "Phụ kiện")
    location.href = "/Group.html"
})